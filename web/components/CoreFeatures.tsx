...
const features = [
  {
    ...
    description:
      "Get started with Zync in seconds through a streamlined registration experience designed for security and simplicity.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Create structured group workspaces where teams can collaborate, share ideas, and manage conversations efficiently.",
    bullets: [
    ...
    image: "/screenshots/groups.webp",
    accent: "#003EE3",
  },
  {
    title: "Channel-Based Collaboration",
    description:
      "Use dedicated channels to keep discussions organized across projects, topics, or departments.",
    bullets: [
    ...
    image: "/screenshots/channels.webp",
    accent: "#FF3366",
  },
  {
    title: "Instant Messaging",
    description:
      "Communicate instantly with colleagues or friends through lightning-fast real-time messaging.",
    bullets: [
      "Send and receive messages instantly",
      "Quickly search conversations and contacts",
      "See message previews and activity updates in real time",
    ],
    image: "/screenshots/chat.webp",
    accent: "#003EE3",
  },
  {
    title: "Smart Group Management",
    description:
      "Manage teams effortlessly with advanced group settings and integrated AI tools.",
    bullets: [
    ...
    image: "/screenshots/group-settings.webp",
    accent: "#FF3366",
  },
  {
    title: "Advanced Account Security",
    description:
      "Protect your account with multiple layers of authentication and security controls.",
    bullets: [
...
export default function CoreFeatures() {
  return (
    <section
      id="features"
      className="py-28 bg-[#0E1013] overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
            Explore Zync’s Core Features
          </h2>

          <p className="text-xl text-gray-400 max-w-2xl mx-auto text-balance">
            Powerful tools designed to streamline communication,
            collaboration, and security for modern teams.
          </p>
        </div>
